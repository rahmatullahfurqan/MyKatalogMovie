 ...
 */
public class SearchMovieFragment extends Fragment implements MovieView {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        etSearchMovie = view.findViewById(R.id.et_movie_name);
        btnSearchMovie = view.findViewById(R.id.btn_search);
        ...
        moviePresenter.getSearchMovie(apiKey, Utils.language, "a");
        btnSearchMovie.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showProgressBar();
                moviePresenter.getSearchMovie(apiKey, Utils.language, etSearchMovie.getText().toString());
            }
        });
    }
